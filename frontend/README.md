...
> This is the **Next.js app** living in `frontend/`. Server-side Firebase config,
> seed tooling, and the data/region playbook live in [`../backend/`](../backend/README.md).
...
│   └── api/           # Backend-for-frontend API routes (AI, payments, cron)
